...
import co.amity.amitychat.ui.chats.conversation.ConversationScreen
import co.amity.amitychat.ui.chats.list.ChatsScreen
import co.amity.amitychat.ui.login.LoginScreen
import co.amity.amitychat.ui.users.UsersScreen
...
fun MainNavigation(
    ...
    NavHost(navController = navController, startDestination = Route.Loading.route) {
        ...
        composable(Route.UsersList.route) {
            UsersScreen(
                modifier = modifier,
                navigateToConversation = { navController.navigate(Route.Conversation.route) })
        }
            ...
            ChatsScreen(
                ...
                navigateToConversation = { conversationId ->
                    navController.navigate(
                        Route.Conversation.createRoute(
                            conversationId
                        )
                    )
                })
